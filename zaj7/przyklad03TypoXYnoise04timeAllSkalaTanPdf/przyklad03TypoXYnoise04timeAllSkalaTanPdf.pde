...
void draw() {
  ...
  {
    float xp = punkty[nr].x-skala*tan(nr*0.1+t);;
    float yp = punkty[nr].y-skala*tan(100+nr*0.1+t);;
    float xk = punkty[nr].x+skala*tan(1000+nr*0.1+t);
    float yk = punkty[nr].y+skala*tan(10000+nr*0.1+t);
    line(xp, yp, xk, yk);
    nr = nr + 1;
