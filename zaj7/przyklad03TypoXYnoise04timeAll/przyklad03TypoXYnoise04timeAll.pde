...
void draw() {
  ...
  {
    float xp = punkty[nr].x-15*noise(nr*0.1+t);;
    float yp = punkty[nr].y-15*noise(100+nr*0.1+t);;
    float xk = punkty[nr].x+15*noise(1000+nr*0.1+t);
    float yk = punkty[nr].y+15*noise(10000+nr*0.1+t);
    line(xp, yp, xk, yk);
    nr = nr + 1;
